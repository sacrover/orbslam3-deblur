...
namespace ORB_SLAM3
{
          ...
          mpCamera2(nullptr), mbHasPose(false), mbHasVelocity(false)
    {
        ...
        // Update Map Points based on Blur
        // Deblur BlurTest(2.2, 270);
        // BlurTest.VarLaplacian(imGray);
        // // std::cout << "Image: " << BlurTest.ImageBlurReport() << std::endl;
        // if (BlurTest.ImageBlurReport())
        // {
        //     std::cout << "Culling Blur Map Points" << std::endl;
        //     mvKeysUn = BlurTest.BlurKeyPointCulling(mvKeysUn, imGray);
        //     // usleep(3.5 * 1e-6);
        // }
