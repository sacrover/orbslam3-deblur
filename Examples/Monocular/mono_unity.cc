...
//  ./Examples/Monocular/mono_unity ./Vocabulary/ORBvoc.txt ./Examples/Monocular/Unity.yaml /media/sv/T7Shield/0001Deblur/Fooflake-Dataset/Blur/resized /media/sv/T7Shield/0001Deblur/Fooflake-Dataset/Blur/resized/timestamps.txt dataset-Unity_mono
